...
Check the top-level render call using <` + parentName + ">.");
      ...
      exports.Children = Children2, exports.Component = Component2, exports.Fragment = REACT_FRAGMENT_TYPE, exports.Profiler = REACT_PROFILER_TYPE, exports.PureComponent = PureComponent, exports.StrictMode = REACT_STRICT_MODE_TYPE, exports.Suspense = REACT_SUSPENSE_TYPE, exports.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = ReactSharedInternals, exports.cloneElement = cloneElement$1, exports.createContext = createContext4, exports.createElement = createElement$1, exports.createFactory = createFactory, exports.createRef = createRef, exports.forwardRef = forwardRef4, exports.isValidElement = isValidElement2, exports.lazy = lazy2, exports.memo = memo, exports.startTransition = startTransition, exports.unstable_act = act, exports.useCallback = useCallback4, exports.useContext = useContext6, exports.useDebugValue = useDebugValue2, exports.useDeferredValue = useDeferredValue, exports.useEffect = useEffect8, exports.useId = useId, exports.useImperativeHandle = useImperativeHandle, exports.useInsertionEffect = useInsertionEffect, exports.useLayoutEffect = useLayoutEffect4, exports.useMemo = useMemo9, exports.useReducer = useReducer, exports.useRef = useRef3, exports.useState = useState8, exports.useSyncExternalStore = useSyncExternalStore2, exports.useTransition = useTransition2, exports.version = ReactVersion, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    })();
  }
});
...
Check the top-level render call using <` + parentName + ">.");
      ...
      var jsx7 = jsxWithValidationDynamic, jsxs2 = jsxWithValidationStatic;
      exports.Fragment = REACT_FRAGMENT_TYPE, exports.jsx = jsx7, exports.jsxs = jsxs2;
    })();
  }
});
...
var tailwind_build_default = "/build/_assets/tailwind-build-YMNVYMGO.css";
...
function useMoney(money) {
  ...
  let amount = parseFloat(money.amount), options = (0, import_react5.useMemo)(
    () => ({
      style: "currency",
    ...
    minimumFractionDigits: 0,
    maximumFractionDigits: 0
  }), isPartCurrency = (part) => part.type === "currency", lazyFormatters = (0, import_react5.useMemo)(
    () => ({
      original: () => money,
...
var Image = React7.forwardRef(
  ({
    ...
    let normalizedData = React7.useMemo(() => {
      let dataWidth = (data == null ? void 0 : data.width) && (data == null ? void 0 : data.height) ? data == null ? void 0 : data.width : void 0, dataHeight = (data == null ? void 0 : data.width) && (data == null ? void 0 : data.height) ? data == null ? void 0 : data.height : void 0;
      return {
        width: dataWidth,
        height: dataHeight,
      ...
      let nAlt = (data == null ? void 0 : data.altText) && !alt ? data == null ? void 0 : data.altText : alt || "", nAspectRatio = aspectRatio || (normalizedData.unitsMatch ? [
...
function FixedWidthImage({
  ...
  }, [aspectRatio, crop, height, imageWidths, loader7, normalizedProps, width]);
...
function FluidImage({
  ...
  let fluid = React7.useMemo(() => {
    let sizesArray = imageWidths === void 0 ? void 0 : generateSizes(imageWidths, normalizedProps.aspectRatio, crop), placeholderHeight = normalizedProps.aspectRatio && placeholderWidth ? placeholderWidth * (parseAspectRatio(normalizedProps.aspectRatio) ?? 1) : void 0, srcSet = generateSrcSet(normalizedProps.src, sizesArray, loader7), src = loader7({
      src: normalizedProps.src,
  ...
  }, [crop, imageWidths, loader7, normalizedProps, placeholderWidth]);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "img",
    {
      ref,
...
function generateSrcSet(src, sizesArray, loader7 = shopifyLoader) {
...
var import_jsx_runtime5 = __toESM(require_jsx_runtime(), 1), import_react6 = __toESM(require_react(), 1);
...
var import_jsx_runtime6 = __toESM(require_jsx_runtime(), 1), import_react8 = __toESM(require_react(), 1);

// node_modules/@shopify/hydrogen-react/dist/browser-dev/load-script.mjs
var import_react7 = __toESM(require_react(), 1), SCRIPTS_LOADED = {};
...
function useLoadScript(url, options) {
  let [status, setStatus] = (0, import_react7.useState)("loading"), stringifiedOptions = JSON.stringify(options);
...
function ModelViewer(props) {
  var _a2, _b, _c;
  let [modelViewer, setModelViewer] = (0, import_react8.useState)(
    void 0
  ), callbackRef = (0, import_react8.useCallback)((node) => {
    setModelViewer(node);
...
}, LIB_VERSION = "2023.4.4", StorefrontApiError = class extends Error {
...
async function storefrontRedirect(options) {
  ...
  if (pathname === "/admin" && !noAdminRedirect)
    return redirect6(`${storefront.getShopifyDomain()}/admin`);
  try {
...
function ProductGrid({ collection, url }) {
  let [nextPage, setNextPage] = (0, import_react12.useState)(
    collection.products.pageInfo.hasNextPage
  ), [endCursor, setEndCursor] = (0, import_react12.useState)(
    collection.products.pageInfo.endCursor
  ), [products, setProducts] = (0, import_react12.useState)(collection.products.nodes || []), fetcher = useFetcher2();
...
function ProductOptions({ options, selectedVariant }) {
  let { pathname, search } = useLocation(), [currentSearchParams] = useSearchParams(), navigation = useNavigation(), paramsWithDefaults = (() => {
    let defaultParams = new URLSearchParams(currentSearchParams);
    if (!selectedVariant)
      return defaultParams;
    for (let { name, value } of selectedVariant.selectedOptions)
      currentSearchParams.has(name) || defaultParams.set(name, value);
    return defaultParams;
  })(), searchParams = navigation.location ? new URLSearchParams(navigation.location.search) : paramsWithDefaults;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "grid gap-4 mb-6", children: options.map((option) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("h3", { className: "whitespace-pre-wrap max-w-prose font-bold text-lead min-w-[4rem]", children: option.name }, void 0, !1, {
            fileName: "app/components/ProductOptions.jsx",
            lineNumber: 48,
            columnNumber: 13
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "flex flex-wrap items-baseline gap-4", children: option.values.map((value) => {
            let linkParams = new URLSearchParams(searchParams), isSelected = currentOptionVal === value;
            return linkParams.set(option.name, value), /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(
              Link2,
              {
...
async function loader3({ params, context, request }) {
  var _a2;
  let { handle: handle2 } = params, searchParams = new URL(request.url).searchParams, selectedOptions = [];
  ...
  if (!(product != null && product.id))
    throw new Response(null, { status: 404 });
  let selectedVariant = product.selectedVariant ?? ((_a2 = product == null ? void 0 : product.variants) == null ? void 0 : _a2.nodes[0]);
  return json3({
    product,
    selectedVariant
  });
...
function ProductHandle() {
  var _a2;
  let { product, selectedVariant } = useLoaderData2(), isDiscounted = selectedVariant.compareAtPrice != null;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("section", { className: "w-full gap-4 md:gap-8 grid px-6 md:px-8 lg:px-12", children: /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { className: "grid items-start gap-6 lg:gap-20 md:grid-cols-2 lg:grid-cols-3", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { className: "grid md:grid-flow-row  md:p-0 md:overflow-x-hidden md:grid-cols-2 md:w-full lg:col-span-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { className: "md:col-span-2 snap-center card-image aspect-square md:w-full w-[80vw] shadow rounded", children: /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(ProductGallery, { media: product.media.nodes }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { className: "md:sticky md:mx-auto max-w-xl md:max-w-[24rem] grid gap-8 p-0 md:p-6 md:px-0 top-[6rem] lg:top-[8rem] xl:top-[10rem]", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { className: "grid gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("h1", { className: "text-4xl font-bold leading-10 whitespace-normal", children: product.title }, void 0, !1, {
          fileName: "app/routes/products.$handle.jsx",
          lineNumber: 57,
          columnNumber: 15
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("p", { children: [
          " ",
          isDiscounted ? /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("span", { children: "Old Price:" }, void 0, !1, {
              fileName: "app/routes/products.$handle.jsx",
              lineNumber: 61,
              columnNumber: 28
            }, this),
            ...
            lineNumber: 61,
            columnNumber: 23
          }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("p", { children: [
            "Price: ",
            /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(
              Money,
              {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("span", { className: "max-w-prose whitespace-pre-wrap inherit text-copy opacity-50 font-medium", children: product.vendor }, void 0, !1, {
          fileName: "app/routes/products.$handle.jsx",
          lineNumber: 81,
          columnNumber: 15
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("p", { children: [
        "Selected Variant: ",
        (_a2 = product.selectedVariant) == null ? void 0 : _a2.id
      ] }, void 0, !0, {
        fileName: "app/routes/products.$handle.jsx",
        lineNumber: 90,
        columnNumber: 13
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(
    "div",
    {
      ...
      children: media.map((med, i) => {
        let extraProps = {};
        med.mediaContentType === "MODEL_3D" && (extraProps = {
...
var prods_id_exports = {};
__export(prods_id_exports, {
  default: () => ProductHandle2,
  loader: () => loader4
});
var import_jsx_dev_runtime9 = __toESM(require_jsx_dev_runtime());
async function loader4({ params, context, request }) {
  var _a2;
  let { id } = params, searchParams = new URL(request.url).searchParams, selectedOptions = [];
  searchParams.forEach((value, name) => {
    selectedOptions.push({ name, value });
  });
  let { product } = await context.storefront.query(PRODUCT_QUERY2, {
    variables: {
...
function ProductHandle2() {
  var _a2;
  let { product, selectedVariant } = useLoaderData2(), isDiscounted = selectedVariant.compareAtPrice != null;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("section", { className: "w-full gap-4 md:gap-8 grid px-6 md:px-8 lg:px-12", children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "grid items-start gap-6 lg:gap-20 md:grid-cols-2 lg:grid-cols-3", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "grid md:grid-flow-row  md:p-0 md:overflow-x-hidden md:grid-cols-2 md:w-full lg:col-span-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "md:col-span-2 snap-center card-image aspect-square md:w-full w-[80vw] shadow rounded", children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(ProductGallery2, { media: product.media.nodes }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "md:sticky md:mx-auto max-w-xl md:max-w-[24rem] grid gap-8 p-0 md:p-6 md:px-0 top-[6rem] lg:top-[8rem] xl:top-[10rem]", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "grid gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("h1", { className: "text-4xl font-bold leading-10 whitespace-normal", children: product.title }, void 0, !1, {
          fileName: "app/routes/prods.$id.jsx",
          lineNumber: 57,
          columnNumber: 15
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("p", { children: [
          " ",
          isDiscounted ? /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("span", { children: "Old Price:" }, void 0, !1, {
              fileName: "app/routes/prods.$id.jsx",
              lineNumber: 61,
              columnNumber: 28
            }, this),
            ...
            lineNumber: 61,
            columnNumber: 23
          }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("p", { children: [
            "Price: ",
            /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(
              Money,
              {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("span", { className: "max-w-prose whitespace-pre-wrap inherit text-copy opacity-50 font-medium", children: product.vendor }, void 0, !1, {
          fileName: "app/routes/prods.$id.jsx",
          lineNumber: 81,
          columnNumber: 15
        }, this)
...
function ProductGallery2({ media }) {
  if (!media.length)
    return null;
  let typeNameMap = {
    MODEL_3D: "Model3d",
...
async function loader5({ context }) {
  return await context.storefront.query(COLLECTIONS_QUERY);
}
function Index() {
  let { collections } = useLoaderData2();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("section", { className: "w-full gap-4", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("h2", { className: "whitespace-pre-wrap max-w-prose font-bold text-lead", children: "Collections" }, void 0, !1, {
      fileName: "app/routes/_index.jsx",
      lineNumber: 16,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("div", { className: "grid-flow-row grid gap-2 gap-y-6 md:gap-4 lg:gap-6 grid-cols-1 sm:grid-cols-3", children: collections.nodes.map((collection) => /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(Link2, { to: `/collections/${collection.handle}`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("div", { className: "grid gap-4", children: [
      (collection == null ? void 0 : collection.image) && /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(
        Image,
        {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("h2", { className: "whitespace-pre-wrap max-w-prose font-medium text-copy", children: collection.title }, void 0, !1, {
        fileName: "app/routes/_index.jsx",
        lineNumber: 37,
        columnNumber: 17
      }, this)
...
function Layout2(props) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("div", { className: "hydrogen-virtual-route", children: props.children }, void 0, !1, {
...
// node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx
var import_jsx_dev_runtime12 = __toESM(require_jsx_dev_runtime(), 1), links2 = () => [
  { rel: "stylesheet", href: styles_default },
  { rel: "icon", type: "image/svg+xml", href: favicon_default2 }
];
function App2() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("html", { lang: "en", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("head", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("meta", { charSet: "utf-8" }, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 20,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("meta", { name: "viewport", content: "width=device-width,initial-scale=1" }, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 21,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("title", { children: "Hydrogen" }, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 22,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("meta", { name: "description", content: "A custom storefront powered by Hydrogen" }, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 23,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)(Meta, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 24,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)(Links, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 25,
        columnNumber: 7
      }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)("body", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)(Layout2, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)(Outlet, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 28,
        columnNumber: 15
      }, this) }, void 0, !1, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)(ScrollRestoration2, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 29,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime12.jsxDEV)(Scripts, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 30,
        columnNumber: 7
      }, this)
...
var assets_manifest_default = { version: "88630821", entry: { module: "/build/entry.client-MA4E2MAO.js", imports: ["/build/_shared/chunk-DK2Z6Z7L.js", "/build/_shared/chunk-5KL4PAQL.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-MZ4AUKV4.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/_index": { id: "routes/_index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/_index-3UWZKRL4.js", imports: ["/build/_shared/chunk-NBQRRR4V.js", "/build/_shared/chunk-ZEGRJOPV.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/collections.$handle": { id: "routes/collections.$handle", parentId: "root", path: "collections/:handle", index: void 0, caseSensitive: void 0, module: "/build/routes/collections.$handle-MV65ZWJX.js", imports: ["/build/_shared/chunk-NBQRRR4V.js", "/build/_shared/chunk-ZEGRJOPV.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/prods.$id": { id: "routes/prods.$id", parentId: "root", path: "prods/:id", index: void 0, caseSensitive: void 0, module: "/build/routes/prods.$id-HSYLCS52.js", imports: ["/build/_shared/chunk-MXLE3752.js", "/build/_shared/chunk-ZEGRJOPV.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/products.$handle": { id: "routes/products.$handle", parentId: "root", path: "products/:handle", index: void 0, caseSensitive: void 0, module: "/build/routes/products.$handle-5T2RMPV3.js", imports: ["/build/_shared/chunk-MXLE3752.js", "/build/_shared/chunk-ZEGRJOPV.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "virtual-routes/routes/graphiql": { id: "virtual-routes/routes/graphiql", parentId: "virtual-routes/virtual-root", path: "graphiql", index: void 0, caseSensitive: void 0, module: "/build/virtual-routes/routes/graphiql-GPDYRMZP.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "virtual-routes/virtual-root": { id: "virtual-routes/virtual-root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/virtual-routes/virtual-root-U6QXSOG2.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, cssBundleHref: void 0, hmr: void 0, url: "/build/manifest-88630821.js" };
