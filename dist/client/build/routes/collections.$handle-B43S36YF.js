...
function ProductGrid({ collection, url }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("section", { className: "w-full gap-4 md:gap-8 grid", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "grid-flow-row grid gap-2 gap-y-6 md:gap-4 lg:gap-6 grid-cols-2 md:grid-cols-3 lg:grid-cols-4", children: products.nodes.map((product) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ProductCard, { product }, product.id, false, {
    ...
    products.pageInfo.hasNextPage && /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex items-center justify-center mt-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("button", { className: "inline-block rounded font-medium text-center py-3 px-6 border w-full cursor-pointer", children: "Load more products" }, void 0, false, {
      fileName: "app/components/ProductGrid.jsx",
      lineNumber: 13,
      columnNumber: 11
    }, this) }, void 0, false, {
...
//# sourceMappingURL=/build/routes/collections.$handle-B43S36YF.js.map
