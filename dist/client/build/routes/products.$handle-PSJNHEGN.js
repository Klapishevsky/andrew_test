...
function ProductHandle() {
  const testParams = new URLSearchParams(window.location.pathname);
  const prodHandle = testParams.get("handle");
...
//# sourceMappingURL=/build/routes/products.$handle-PSJNHEGN.js.map
