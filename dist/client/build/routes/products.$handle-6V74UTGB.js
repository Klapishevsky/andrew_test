...
function ProductHandle() {
  const { product: product2, selectedVariant } = useLoaderData();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("section", { className: "w-full gap-4 md:gap-8 grid px-6 md:px-8 lg:px-12", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "grid items-start gap-6 lg:gap-20 md:grid-cols-2 lg:grid-cols-3", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "grid md:grid-flow-row  md:p-0 md:overflow-x-hidden md:grid-cols-2 md:w-full lg:col-span-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "md:col-span-2 snap-center card-image aspect-square md:w-full w-[80vw] shadow rounded", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ProductGallery, { media: product2.media.nodes }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "md:sticky md:mx-auto max-w-xl md:max-w-[24rem] grid gap-8 p-0 md:p-6 md:px-0 top-[6rem] lg:top-[8rem] xl:top-[10rem]", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "grid gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("h1", { className: "text-4xl font-bold leading-10 whitespace-normal", children: product2.title }, void 0, false, {
          fileName: "app/routes/products.$handle.jsx",
          lineNumber: 57,
          columnNumber: 15
        }, this),
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ProductPrice, {}, void 0, false, {
          fileName: "app/routes/products.$handle.jsx",
          lineNumber: 70,
          columnNumber: 15
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("span", { className: "max-w-prose whitespace-pre-wrap inherit text-copy opacity-50 font-medium", children: product2.vendor }, void 0, false, {
          fileName: "app/routes/products.$handle.jsx",
          lineNumber: 71,
          columnNumber: 15
        }, this)
...
//# sourceMappingURL=/build/routes/products.$handle-6V74UTGB.js.map
